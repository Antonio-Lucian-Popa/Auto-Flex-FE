    ...
    return (
      <div className="max-w-4xl mx-auto py-12 px-6">
        ...
        <div className="mt-12 text-sm text-muted-foreground">
          Ai întrebări? Vizitează pagina de <a href="/contact" className="text-primary underline">Contact</a> sau consultă secțiunile{" "}
          <a href="/terms" className="text-primary underline">Termeni și condiții</a> și{" "}
          <a href="/privacy" className="text-primary underline">Politica de confidențialitate</a>.
        </div>
      </div>
    )
  }
